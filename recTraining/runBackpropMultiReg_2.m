...
load ../weights/graspWL1_2
W1 = W_2;

load ../weights/graspWL2_2
W2 = W_2;
...
%%%%%%%%%%%%%%% END OF CONJUGATE GRADIENT WITH 3 LINESEARCHES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 save ~/backpropData/classify_weights_2 W1 W2 W_class
 save ~/backpropData/classify_error_2 test_err test_crerr train_err train_crerr;
