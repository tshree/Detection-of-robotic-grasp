%%no. of features to be learnt in second layer of second pass network= 200
...
W_2 = reshape(opttheta(1:params.numFeatures*params.n), params.numFeatures, params.n);   %%changed from W to W_2
