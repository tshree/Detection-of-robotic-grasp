...
load ../../weights/graspWFinal_2.mat
load ../../data/graspWhtParams.mat

w_class = w_class(:,1);
W_class=W_class(:,1);
bestRects = getGraspForSelectionDisplay(I,D,DBG,w1,w2,w_class,featMeans,featStds,0:30:(30*5),10:10:90,10:10:90,10,trainModes);
