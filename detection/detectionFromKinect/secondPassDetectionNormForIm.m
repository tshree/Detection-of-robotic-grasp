...
function [bestRects,bestScore] =secondPassDetectionNormForIm(objI,objD,objM,w1,w2,wClass,means,stds,rotAngs,hts,wds,scanStep,modes)
...
bestRects = localRectToIm(rectPoints,bestAng,bbCorners,count);
