...
function bestRect= getGraspForSelection(I,D,BG,w1,w2,wClass,W1,W2,Wclass,means,stds,rotAngs,hts,wds,scanStep,modes)

addpath /home/niladri-64/deepGraspingCode_TG/detection/detectionUtils/
addpath /home/niladri-64/deepGraspingCode_TG/util/
...
while true
    ...
    figure(2);
    myBest = onePassDetectionNormForIm(I1,D1,ones(size(D1)),w1,w2,wClass,W1,W2,Wclass,means,stds,rotAngs,hts,wds,scanStep,modes);
   close; 
